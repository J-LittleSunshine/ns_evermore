...
class NsRuntimeConfig:
    ...
    def ensure_runtime_broker_backend_implemented(self) -> None:
        ...
        if backend in {
            RUNTIME_BACKEND_REDIS,
            RUNTIME_BACKEND_VALKEY
        } and not str(self.runtime_broker_location or "").strip():
    ...
    def validate(self) -> None:
        ...
        if self.backend_outbox_backend not in {
            RUNTIME_BACKEND_SQL_WAL,
            RUNTIME_BACKEND_REDIS,
            RUNTIME_BACKEND_VALKEY,
            RUNTIME_BACKEND_MQ
        ...
        if self.runtime_ingress_backend not in {
            RUNTIME_BACKEND_SQL_WAL,
            RUNTIME_BACKEND_REDIS,
            RUNTIME_BACKEND_VALKEY,
            RUNTIME_BACKEND_MQ
        ...
        if self.runtime_broker_backend not in {
            RUNTIME_BACKEND_MEMORY,
            RUNTIME_BACKEND_REDIS,
            RUNTIME_BACKEND_VALKEY,
            RUNTIME_BACKEND_MQ
        ...
        if self.runtime_presence_backend not in {
            RUNTIME_BACKEND_MEMORY,
            RUNTIME_BACKEND_REDIS,
            RUNTIME_BACKEND_VALKEY,
            RUNTIME_BACKEND_SQL_WAL
