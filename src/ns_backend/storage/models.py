...
class StorageObjectRef(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["module_code", "resource_type", "resource_id"], name="idx_storage_obj_ref_res"),
            models.Index(fields=["sha256"], name="idx_storage_obj_ref_sha256"),
            models.Index(fields=["created_at"], name="idx_storage_obj_ref_created"),
            models.Index(fields=["deleted_at"], name="idx_storage_obj_ref_deleted"),
        ]
        constraints = [
            models.UniqueConstraint(fields=["bucket", "object_name"], name="uk_storage_obj_ref_bucket_name"),
        ]
