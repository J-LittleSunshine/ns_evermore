    ...
    def _build_deny_all_filter(cls, *, reason: str, access_mode: str | None = None, retry_count: int = 0) -> dict[str, Any]:
        return {
            ...
            "filters": {
                ...
                "reason": reason,
                "orm": {
                    "include": {f"{cls.DEFAULT_RESOURCE_ID_FIELD}__in": []},
                    "exclude": {},
                },
                "vector": {
                    "must": {"terms": {cls.DEFAULT_RESOURCE_ID_FIELD: []}},
                    "must_not": {},
                },
                "data_scope": {},
            },
    ...
    async def _resolve_retrieval_filter_once(
        ...
        if access_mode == RESOURCE_ACCESS_MODE_ACL_REQUIRED:
            ...
            if resolved_allow_ids:
                ...
                vector_must["terms"] = {cls.DEFAULT_RESOURCE_ID_FIELD: resolved_allow_ids}
            else:
                deny_all = True
                reason = data_scope_reason or "ACL_REQUIRED_NO_RESOURCE_ALLOW"
                orm_include[f"{cls.DEFAULT_RESOURCE_ID_FIELD}__in"] = []
                vector_must["terms"] = {cls.DEFAULT_RESOURCE_ID_FIELD: []}
        else:
        ...
        if resolved_deny_ids:
            ...
            vector_must_not["terms"] = {cls.DEFAULT_RESOURCE_ID_FIELD: resolved_deny_ids}
