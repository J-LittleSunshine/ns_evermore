...
async def retry_with_backoff(operation: Callable[[], Awaitable[T]], *, max_retries: int, base_delay_ms: int, max_delay_ms: int, jitter_ratio: float, retryable_exceptions: tuple[type[Exception], ...], operation_name: str = "iam_operation") -> T:
