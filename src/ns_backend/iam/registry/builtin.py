...
IAM_BUILTIN_PERMISSION_SPECS: tuple[PermissionSpec, ...] = (
    ...
    PermissionSpec(permission_code="iam:auth:logout", permission_name="Logout", permission_type=PERMISSION_TYPE_ACTION, parent_code="iam:auth"),
    ...
    PermissionSpec(permission_code="iam:session:list", permission_name="List sessions", permission_type=PERMISSION_TYPE_ACTION, parent_code="iam:session"),
    ...
    PermissionSpec(permission_code="iam:company:list", permission_name="List companies", permission_type=PERMISSION_TYPE_ACTION, parent_code="iam:company"),
    PermissionSpec(permission_code="iam:company:detail", permission_name="Company detail", permission_type=PERMISSION_TYPE_ACTION, parent_code="iam:company"),
    ...
    PermissionSpec(permission_code="iam:subsidiary:list", permission_name="List subsidiaries", permission_type=PERMISSION_TYPE_ACTION, parent_code="iam:subsidiary"),
    PermissionSpec(permission_code="iam:subsidiary:detail", permission_name="Subsidiary detail", permission_type=PERMISSION_TYPE_ACTION, parent_code="iam:subsidiary"),
    ...
    PermissionSpec(permission_code="iam:department:list", permission_name="List departments", permission_type=PERMISSION_TYPE_ACTION, parent_code="iam:department"),
    PermissionSpec(permission_code="iam:department:detail", permission_name="Department detail", permission_type=PERMISSION_TYPE_ACTION, parent_code="iam:department"),
    ...
    PermissionSpec(permission_code="iam:permission:list", permission_name="List permissions", permission_type=PERMISSION_TYPE_ACTION, parent_code="iam:permission"),
    PermissionSpec(permission_code="iam:permission:detail", permission_name="Permission detail", permission_type=PERMISSION_TYPE_ACTION, parent_code="iam:permission"),
    ...
    PermissionSpec(permission_code="iam:resource:list", permission_name="List resources", permission_type=PERMISSION_TYPE_ACTION, parent_code="iam:resource"),
    PermissionSpec(permission_code="iam:resource:detail", permission_name="Resource detail", permission_type=PERMISSION_TYPE_ACTION, parent_code="iam:resource"),
    ...
    PermissionSpec(permission_code="iam:resource_action:list", permission_name="List resource actions", permission_type=PERMISSION_TYPE_ACTION, parent_code="iam:resource_action"),
    PermissionSpec(permission_code="iam:resource_action:detail", permission_name="Resource action detail", permission_type=PERMISSION_TYPE_ACTION, parent_code="iam:resource_action"),
    ...
    PermissionSpec(permission_code="iam:resource_relation:list", permission_name="List resource relations", permission_type=PERMISSION_TYPE_ACTION, parent_code="iam:resource_relation"),
    ...
    PermissionSpec(permission_code="iam:resource_acl:list", permission_name="List resource ACLs", permission_type=PERMISSION_TYPE_ACTION, parent_code="iam:resource_acl"),
    ...
    PermissionSpec(permission_code="iam:role:list", permission_name="List roles", permission_type=PERMISSION_TYPE_ACTION, parent_code="iam:role"),
    PermissionSpec(permission_code="iam:role:detail", permission_name="Role detail", permission_type=PERMISSION_TYPE_ACTION, parent_code="iam:role"),
    ...
    PermissionSpec(permission_code="iam:user:list", permission_name="List users", permission_type=PERMISSION_TYPE_ACTION, parent_code="iam:user"),
    PermissionSpec(permission_code="iam:user:detail", permission_name="User detail", permission_type=PERMISSION_TYPE_ACTION, parent_code="iam:user"),
    ...
    PermissionSpec(permission_code="iam:policy:list", permission_name="List policies", permission_type=PERMISSION_TYPE_ACTION, parent_code="iam:policy"),
    PermissionSpec(permission_code="iam:policy:detail", permission_name="Policy detail", permission_type=PERMISSION_TYPE_ACTION, parent_code="iam:policy"),
    ...
    PermissionSpec(permission_code="iam:policy_rule:list", permission_name="List policy rules", permission_type=PERMISSION_TYPE_ACTION, parent_code="iam:policy_rule"),
    PermissionSpec(permission_code="iam:policy_rule:detail", permission_name="Policy rule detail", permission_type=PERMISSION_TYPE_ACTION, parent_code="iam:policy_rule"),
    ...
    PermissionSpec(permission_code="iam:audit:decision:list", permission_name="List decision audit logs", permission_type=PERMISSION_TYPE_ACTION, parent_code="iam:audit"),
    PermissionSpec(permission_code="iam:audit:operation:list", permission_name="List operation audit logs", permission_type=PERMISSION_TYPE_ACTION, parent_code="iam:audit"),
)
