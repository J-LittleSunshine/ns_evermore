...
SUPPORTED_INFRA_SQL_OPERATIONS = (SQL_OPERATION_CREATE,)
...
def build_infra_sql_path(*, sql_root: str | Path, operation: str, infra_domain: str, vendor: str) -> Path:
...
def build_infra_create_sql_path(*, sql_root: str | Path, infra_domain: str, vendor: str) -> Path:
    return build_infra_sql_path(sql_root=sql_root, operation=SQL_OPERATION_CREATE, infra_domain=infra_domain, vendor=vendor)
