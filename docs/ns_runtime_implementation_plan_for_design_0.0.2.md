...
| 最近已验证工作包 | `P05-FIX-03 pre-index candidate cleanup ownership + draining terminal convergence` |
...
| 设计基线版本 | `0.0.2` |
| wire codec | `json.v1` |
| 当前正式 transport | `websocket_tcp` adapter 为 `VERIFIED/F2`；P05 composition 已由 `P05-FIX-01` 闭环、`P05-FIX-02` 加固 indexed lifecycle、`P05-FIX-03` 补齐 pre-index candidate cleanup 与 draining terminal convergence，P06 前 ordinary production connection 继续 fail-closed |
