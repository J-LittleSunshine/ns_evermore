...
| `P04-W02` | `IN_PROGRESS` | 定义 capability 集合并为 websocket_tcp 声明 reliable_ordered_messages、native_keepalive、transport_flow_control 基础能力 | capability 由 adapter 权威声明 |
