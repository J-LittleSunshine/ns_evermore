...
| 最近已验证工作包 | `P05-W09 one-way bounded connection drain` |
...
| `P05-W10` | `IN_PROGRESS` | 普通网络断开进入默认 30s grace；grace 内 connection 不作为 active target | 路由索引立即移除 active 属性 |
...
|---|---|
| 当前阻塞项 | 无 |
| 下一工作包 | `P05-W10 supervised disconnect grace`（`IN_PROGRESS`） |
