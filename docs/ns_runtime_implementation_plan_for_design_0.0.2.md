...
| 当前工作包 | `P03-W04 基础 schema 与 message.type schema 叠加` |
| 当前工作包状态 | `IN_PROGRESS` |
| 当前阶段状态 | `IN_PROGRESS` |
...
| `P03-W04` | `IN_PROGRESS` | 建立基础 schema + message.type schema 叠加校验 | 类型专属字段缺失时返回稳定错误 |
...
|---|---|
| 当前阻塞项 | 无 |
| 下一工作包 | `P03-W04 基础 schema 与 message.type schema 叠加`（`IN_PROGRESS`） |
