...
| 最近已验证工作包 | `P05-W11 IAM-revalidated resume and epoch fencing` |
...
| `P05-W12` | `IN_PROGRESS` | kick、安全违规、协议严重错误和恶意重复确认设置不可恢复关闭标志 | resume 请求被拒绝并审计 |
...
|---|---|
| 当前阻塞项 | 无 |
| 下一工作包 | `P05-W12 non-resumable security close`（`IN_PROGRESS`） |
