...
> 当前状态校准时间：`2026-07-20T19:20:15+08:00`
...
| 当前状态校准时间 | `VERIFIED` | `2026-07-20T19:20:15+08:00` |
...
| `P02-FIX-05` | `VERIFIED` | 修复 critical event-loop monitor task 异常失败与 RuntimeService 生命周期未联动 | 异常请求统一 shutdown 并保持 FAILED；取消和普通 probe/metric 失败不升级 |
