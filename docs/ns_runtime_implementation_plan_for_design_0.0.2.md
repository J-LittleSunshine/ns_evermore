...
| 最近已验证工作包 | `P05-W03 controlled hello parsing and test IAM boundary` |
...
| `P05-W04` | `IN_PROGRESS` | 完成协议版本和 transport capability 协商并写入 SessionContext | 后续 codec 使用协商结果 |
...
|---|---|
| 当前阻塞项 | 无 |
| 下一工作包 | `P05-W04 protocol/capability negotiation and SessionContext`（`IN_PROGRESS`） |
