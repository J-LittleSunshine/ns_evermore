...
| `P04-W06` | `IN_PROGRESS` | 建立 transport_connection_id、transport_session_id、transport_stream_id、peer 摘要和 path 初始模型 | 诊断字段与 logical connection 分离 |
