...
| 最近已验证工作包 | `P05-W04 protocol/capability negotiation and SessionContext` |
...
| `P05-W05` | `IN_PROGRESS` | 建立 logical connection、transport session、network path 三层映射 | connection_id 不等于 transport ID |
...
|---|---|
| 当前阻塞项 | 无 |
| 下一工作包 | `P05-W05 logical connection/transport session/network path mapping`（`IN_PROGRESS`） |
