...
| 最近已验证工作包 | `P05-W08 native and Envelope heartbeat` |
...
| `P05-W09` | `IN_PROGRESS` | 建立 connection.drain 单向状态；停止新目标分配，保留 ACK/control/health | drain 不可取消 |
...
|---|---|
| 当前阻塞项 | 无 |
| 下一工作包 | `P05-W09 one-way bounded connection drain`（`IN_PROGRESS`） |
