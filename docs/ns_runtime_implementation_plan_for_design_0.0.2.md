...
| 最近已验证工作包 | `P05-W07 connection.accepted activation boundary` |
...
| `P05-W08` | `IN_PROGRESS` | 建立 transport 原生心跳和 envelope heartbeat；envelope heartbeat 经过轻量 processor，不创建 DeliveryRecord | 双层心跳行为可区分 |
...
|---|---|
| 当前阻塞项 | 无 |
| 下一工作包 | `P05-W08 native and Envelope heartbeat`（`IN_PROGRESS`） |
