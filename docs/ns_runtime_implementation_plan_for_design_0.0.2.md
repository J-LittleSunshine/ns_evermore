...
| 最近已验证工作包 | `P05-W10 supervised disconnect grace` |
...
| `P05-W11` | `IN_PROGRESS` | resume 必须重新 IAM 校验并匹配 identity、tenant、component_type；成功递增 connection_epoch | 旧 epoch 消息全部拒绝 |
...
|---|---|
| 当前阻塞项 | 无 |
| 下一工作包 | `P05-W11 IAM-revalidated resume and epoch fencing`（`IN_PROGRESS`） |
