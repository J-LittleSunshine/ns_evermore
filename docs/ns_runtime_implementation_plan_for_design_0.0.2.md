...
| 最近已验证工作包 | `P05-W06 local atomic connection indexes` |
...
| `P05-W07` | `IN_PROGRESS` | connection.accepted 只返回规定的最小字段 | 不泄露 tenant、identity 和完整 capabilities |
...
|---|---|
| 当前阻塞项 | 无 |
| 下一工作包 | `P05-W07 connection.accepted activation boundary`（`IN_PROGRESS`） |
