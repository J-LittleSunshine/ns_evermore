...
| 当前工作包 | `P03-W01 核心 Envelope 分组类型模型` |
| 当前工作包状态 | `IN_PROGRESS` |
| 当前阶段状态 | `IN_PROGRESS` |
...
| ID | 状态 | 实施内容 | 完成判定 |
|---|---|---|---|
| `P03-W01` | `IN_PROGRESS` | 定义核心分组 protocol、message、source、target、route、delivery、stream、auth_context、payload、callback、trace、extensions 的类型模型 | 所有分组有严格字段集合 |
...
| P03 | Envelope 协议层与类型注册表 | `IN_PROGRESS` | F0 | P02 |
...
|---|---|
| 当前阻塞项 | 无 |
| 下一工作包 | `P03-W01 核心 Envelope 分组类型模型`（`IN_PROGRESS`） |
