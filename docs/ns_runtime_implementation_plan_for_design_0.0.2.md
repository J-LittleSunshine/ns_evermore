...
| 最近已验证工作包 | `P05-W01 logical connection state machine` |
...
| `P05-W02` | `IN_PROGRESS` | 第一条有效应用消息强制为 connection.hello；握手超时后关闭 | 非 hello 消息无法进入 processor |
...
|---|---|
| 当前阻塞项 | 无 |
| 下一工作包 | `P05-W02 hello-first 与 handshake deadline`（`IN_PROGRESS`） |
