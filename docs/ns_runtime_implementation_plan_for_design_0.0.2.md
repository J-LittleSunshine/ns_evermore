...
| `P03-W07` | `IN_PROGRESS` | 每个注册项包含 schema、category、默认 reliability、权限声明、processor key、审计级别、feature flag 和响应类型 | 注册完整性测试通过 |
...
|---|---|
| 当前阻塞项 | 无 |
| 下一工作包 | `P03-W07 注册元数据完整性`（`IN_PROGRESS`） |
